...
| `0x04` | 16-bit FAT, partition; of sizes less than 32 MB.
| `0x05` | Extended Partition, (also see 0F below).
| `0x06` | 16-bit FAT, partition; greater than or equal to 32 MB.
| `0x07` | Installable file systems: HPFS or NTFS. Also, QNX and Advanced Unix.
| `0x08` | AIX bootable partition, AIX (Linux), SplitDrive, OS/2 (through Version 1.3), Dell partition spanning multiple drives (array), Commodore DOS.
| `0x09` | AIX data partition, AIX bootable (Linux), Coherent file system, QNX.
...
| `0x0F` | Extended Partition, using INT 13 Extensions; often means it begins past 1024 cylinders.
| `0x10` | OPUS
| `0x11` | Hidden 12-bit FAT.
| `0x12` | Compaq diagnostics.
| `0x14` | Hidden 16-bit FAT, partition <32 MB, Novell DOS 7.0 (result of bug in FDISK?), AST DOS with logical sectored FAT.
...
| `0x21` | reserved (HP Volume Expansion, SpeedStor variant) Oxygen FSo2
