...
class Partition {
  ...
  /**
   * Partition type of protective (U)EFI GPT MBRs
   * @type {Number}
   */
  static EFI_PROTECTIVE = 0xEF

  /**
   * Partition type of hybrid (U)EFI GPT / MBR
   * @type {Number}
   */
  static EFI_HYBRID = 0xEE
